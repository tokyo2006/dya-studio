...
export function RangeValueSelector({
  ...
  useEffect(() => {
    queueMicrotask(() => setSliderValue(value));
  }, [value]);
      ...
      <div className="space-y-4">
        ...
        <div className="text-center">
          ...
          <div className="text-xs text-[var(--color-text-muted)] mt-1">
            {t("rangeValueSelector.selectValue", { min, max })}
          </div>
        </div>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-center">
        ...
        <div className="text-xs text-[var(--color-text-muted)] mt-1">
          {t("rangeValueSelector.range", { min, max })}
        </div>
      </div>
